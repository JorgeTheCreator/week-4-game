...
//make an object for the collect.
  ...
  $(".crystal").click(function(event) {
    ...
    //WIN
      ...
      statusDisplay.html("<span class='text-danger'>you lost! " + collect.goal + "</span>");
      losses++;
      ...
      if (collect.goal - collect.score < 21){
        statusDisplay.html("<span class='text-warning'>becareful, you're going to loose "+collect.goal + "...</span>");
      } else {
      statusDisplay.html("<span class='text-info'>you can do it! "+collect.goal + "...</span>");
      }
    }
  });
